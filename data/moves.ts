...
// Start of my Fakemon Moves
	...
	burrow: {		//Referenced in src/battle-animations.ts on the client side.
		num: 9014,
		accuracy: true,
		basePower: 0,
		onHit(target) {
	...
	magmaburst: {		//Not Finished
		...
		onAfterMoveSecondarySelf(pokemon, target, move) {
			if (pokemon.baseSpecies.baseSpecies === 'Volcalumin' && !pokemon.transformed) {
				...
				pokemon.formeChange('Volcalumin' + volcaluminForme, this.effect, true);
